...
const Profile = () => {
  ...
  return (
    <section className='py-5 px-3 md:p-10 min-h-[calc(100vh-10rem)] bg-slate-900 border-slate-600 border rounded-lg flex items-center justify-center'>

      <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-base md:text-xl rounded-lg'>
