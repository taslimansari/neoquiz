      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={2}>
          ...
          <Controller
            ...
            defaultValue="COMP"
            render={( { field } ) => (
              <FormControl error={Boolean(errors.branch)}>
                ...
                > 
                  ...
                  <MenuItem value={"AIDS"}>Artificial Intelligence & Data Science</MenuItem>
                  <MenuItem value={"ECS"}>Electronics & Computer Science</MenuItem>
                  <MenuItem value={"MECH"}>Mechanical</MenuItem>
                  <MenuItem value={"CIVIL"}>Civil</MenuItem>
                </Select>
                {errors.branch ? <FormHelperText>{errors.branch.message}</FormHelperText> : null}
              </FormControl>
            )}
          />
          <Controller
