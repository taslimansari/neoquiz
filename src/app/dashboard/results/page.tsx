...
import { ResultsFilters } from '@/components/dashboard/result/results-filters';
import { ResultsTable } from '@/components/dashboard/result/results-table';
import type { Result } from '@/components/dashboard/result/results-table';

export const metadata = { title: `Results | Dashboard | ${config.site.name}` } satisfies Metadata;
...
export default function Page(): React.JSX.Element {
  ...
  const paginatedResults = applyPagination(results, page, rowsPerPage);
...
function applyPagination(rows: Result[], page: number, rowsPerPage: number): Result[] {
